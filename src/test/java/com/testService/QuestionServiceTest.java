...
public class QuestionServiceTest {
    ...
    public void testGetAllQuestions() {
        when(questionRepository.findAll()).thenReturn(List.of(
                new Question(1L, "Question 1", "Option 1", "Option 2", "Option 3", "Option 4", "Answer 1", "10", null, null, null),
                new Question(2L, "Question 2", "Option 1", "Option 2", "Option 3", "Option 4", "Answer 2", "15", null, null, null)
        ));
    ...
    public void testGetQuestionById() {
        long questionId = 1L;
        Question question = new Question(questionId, "Question 1", "Option 1", "Option 2", "Option 3", "Option 4", "Answer 1", "10", null, null, null);
    ...
    public void testSaveQuestion() {
        Question questionToSave = new Question(null, "New Question", "Option 1", "Option 2", "Option 3", "Option 4", "Answer", "5", null, null, null);
        Question savedQuestion = new Question(1L, "New Question", "Option 1", "Option 2", "Option 3", "Option 4", "Answer", "5", null, null, null);
